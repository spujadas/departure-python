...
import departure_board.board.data_updater as data_updater
from departure_board.commons import log_function_stdout_to_debug
...
class DataUpdaterRatp(data_updater.DataUpdater):
    ...
    def update(self):
        ...
        try:
            ...
            logger.warning("%s\n> line id %s, line station id %s, direction %s",
